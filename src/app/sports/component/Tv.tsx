...
export default function Tv({eventid}:{eventid:any}) {
    ...
    return (
      <>
        ...
        <Modal size={{base:'sm', md: 'md' }} blockScrollOnMount={false}  isOpen={isOpen} onClose={onOpen} scrollBehavior="inside">
          ...
          <ModalContent className='p-0 lg:fixed lg:right-6 rounded-2xl' >
            ...
            <div className='h-[255px] rounded-[18px]  bg-[#030712] lg:h-[270px]'>
            ...
            <iframe className='text-white' src={`https://nlivetv.lagaikhaipro.com/rtv.php?eventId=${eventid}`} width="100%" height="100%"  color='white' frameBorder="0" allowFullScreen ></iframe>
