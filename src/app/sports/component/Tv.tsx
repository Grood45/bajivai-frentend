      ...
      <>
        ...
        <Modal size={{base:'sm', md: 'md' }}  isOpen={isOpen} onClose={onOpen}>
          ...
          <ModalContent className='p-0 lg:fixed lg:right-6 rounded-2xl' >
            ...
            <div className='h-[255px] rounded-[2xl]  bg-[#030712] lg:h-[270px]'>
            ...
            <iframe className='rounded-2xl' src={`https://nlivetv.lagaikhaipro.com/rtv.php?eventId=${eventid}`} width="100%" height="100%"  frameBorder="0" allowFullScreen ></iframe>
