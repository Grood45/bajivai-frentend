...
import { WithdrawalTransaction } from "../../../../../utils/typescript.module";
...
const WithDrawl = () => {
  ...
  const [allWithdraw, aetallWithdraw] = useState<WithdrawalTransaction[]>();
    ...
    <div className="flex flex-col mt-5 gap-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div
          ...
          className="flex cursor-pointer items-center p-3 gap-2 py-6 w-[100%] rounded-[12px] justify-between"
        >
          <div>
            <p className="font-semibold text-md text-white">
              Pending Withdrawal
