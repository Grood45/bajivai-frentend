...
import WithdrawUpdateModal from "./component/WithdrawUpdateModal";
      ...
      {!show ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="w-[100%] flex justify-center items-center">
                    <WithdrawUpdateModal data={item} id={item._id} />
                  </div>
                </div>
              );
            })}
        ...
        <div>
          ...
          <div className="w-[85%] mt-5 m-auto gap-4 flex flex-col md:flex-row justify-between">
            ...
            >
              <div className="w-[100%] flex flex-col pl-3 mt-5 px-2   gap-8 justify-between ">
                <p className="text-white text-sm font-bold ">
                  Withdrawal Range
                </p>
