...
const MainComponent: React.FC = () => {
  ...
  return (
    ...
    <div className="w-[100%]  flex  min-h-[100vh]">
     ...
     <p className="font-bold text-center font-serif text-red-600  text-5xl">Bajivai</p>
        <form
          onSubmit={handleLogin}
          style={{background:"rgba(6, 4, 8, 0.7)"}}
          className={`p-8    rounded-[20px] mt-3  opacity-7 shadow-lg w-80 sm:w-96 border border-gray-300`}
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-red-600 mt-10 mb-6 text-white p-2 rounded-[12px] w-full hover:bg-[#9A0A09] duration-500 ease-in-out focus:outline-none"
          >
            {loading ? "....." : "Login"}
          </button>
        </form>
