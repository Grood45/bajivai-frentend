...
function BetSlipModal() {
  ...
  return (
    <>
      ...
      <Modal size={"sm"} isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody style={{ padding: "0px" }}>
            ...
            >
              <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ... p-[1px]  rounded-2xl w-[100%] ">
                <div
                  className={`${
                    theme
                      ? `text-[${themeChange.light.textColor1}]`
                  ...
                  } overflow-scroll  relative h-[80vh] shadow-2xl min-h-[400px] rounded-[17px]  flex flex-col w-[100%] `}
                >
                  <div className="sticky top-0 z-10">
                    <div
                      className={`flex z-1 pt-8 ${
                        theme
                          ? `bg-[${themeChange.light.bg1}]`
                          : `bg-[${themeChange.dark.bg1}]`
      ...
      </Accordion>:<div className="text-sm  flex flex-col mt-20 items-center justify-center text-center">
