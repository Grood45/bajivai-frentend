  ...
  const sidebardata = [
    {
      id: 1,
      title: "Home",
      img: <svg xmlns="http://www.w3.org/2000/svg" width="43" height="29" viewBox="0 0 43 29" fill="none">
      <path d="M20.0794 2.40392C20.8619 1.61429 22.1381 1.61429 22.9206 2.40392L36.7426 16.352C37.9937 17.6146 37.0994 19.7598 35.322 19.7598H7.67803C5.9006 19.7598 5.0063 17.6146 6.25741 16.352L20.0794 2.40392Z" fill="white"/>
      <path d="M11.0972 15.7073H31.9036V26.9704C31.9036 28.075 31.0082 28.9704 29.9036 28.9704H13.0972C11.9926 28.9704 11.0972 28.075 11.0972 26.9704V15.7073Z" fill="white"/>
      <rect x="19.4199" y="23.0757" width="4.16129" height="5.89473" fill="#212632"/>
      </svg>,
      route: "/home",
    },
    {
      id: 2,
      title: "Casino",
      img: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="28" viewBox="0 0 32 28" fill="none">
      <rect width="16.0328" height="20.7719" rx="1" transform="matrix(0.972523 0.232807 -0.220656 0.975352 15.7559 0)" fill="white"/>
      <rect x="0.375934" y="0.604079" width="15.0328" height="19.7719" rx="0.5" transform="matrix(0.972523 0.232807 -0.220656 0.975352 15.8995 -0.0726303)" stroke="#444444" stroke-opacity="0.68"/>
      <path d="M19.4518 11.3306L22.6217 7.87264L23.0427 12.7831L20.0254 15.9431L19.4518 11.3306Z" fill="#0B0D0E"/>
      <rect width="16.0511" height="20.7493" rx="1" transform="matrix(0.950957 -0.309323 0.293834 0.955856 0.913086 8.16669)" fill="white"/>
      <rect x="0.622396" y="0.323267" width="15.0511" height="19.7493" rx="0.5" transform="matrix(0.950957 -0.309323 0.293834 0.955856 0.848623 8.37348)" stroke="#444444" stroke-opacity="0.68"/>
      <path d="M9.70667 15.9768L10.7201 11.3396L13.5158 15.3434L12.4859 19.6442L9.70667 15.9768Z" fill="#0B0D0E"/>
      </svg>,
      route: "/casino",
    },
    {
    ...
    },
    {
      ...
      <path d="M25.7899 14.5801V22.9816C25.7899 26.0762 23.152 28.5826 19.8951 28.5826H8.10567C4.84883 28.5826 2.21094 26.0762 2.21094 22.9816V14.5801C2.21094 13.81 2.8741 13.1798 3.68462 13.1798H6.58778C7.39831 13.1798 8.06146 13.81 8.06146 14.5801V18.9769C8.06146 20.0131 8.66567 20.9653 9.62357 21.4554C10.0509 21.6794 10.5225 21.7914 11.0088 21.7914C11.5688 21.7914 12.1288 21.6374 12.6151 21.3293L14.0151 20.4612L15.312 21.2873C16.2109 21.8614 17.3604 21.9314 18.3183 21.4413C19.2909 20.9513 19.8951 20.0131 19.8951 18.9629V14.5801C19.8951 13.81 20.5583 13.1798 21.3688 13.1798H24.3162C25.1267 13.1798 25.7899 13.81 25.7899 14.5801Z" fill="white"/>
      <path d="M28 7.57852V8.97878C28 10.5191 27.2189 11.7793 25.0526 11.7793H2.94737C0.692632 11.7793 0 10.5191 0 8.97878V7.57852C0 6.03824 0.692632 4.77802 2.94737 4.77802H25.0526C27.2189 4.77802 28 6.03824 28 7.57852Z" fill="white"/>
      <path d="M13.4666 4.7799H5.33185C4.8308 4.26181 4.84553 3.46367 5.37606 2.95957L7.46869 0.971212C8.01395 0.453118 8.9129 0.453118 9.45817 0.971212L13.4666 4.7799Z" fill="white"/>
      <path d="M22.6533 4.7799H14.5186L18.527 0.971212C19.0722 0.453118 19.9712 0.453118 20.5165 0.971212L22.6091 2.95957C23.1396 3.46367 23.1543 4.26181 22.6533 4.7799Z" fill="white"/>
      <path d="M16.9048 13.1798C17.7153 13.1798 18.3785 13.81 18.3785 14.5801V18.9629C18.3785 20.0831 17.0669 20.7552 16.0943 20.1251L14.768 19.285C14.2816 18.9769 13.648 18.9769 13.1469 19.285L11.7616 20.1531C10.789 20.7692 9.49219 20.0971 9.49219 18.9909V14.5801C9.49219 13.81 10.1553 13.1798 10.9659 13.1798H16.9048Z" fill="white"/>
    </svg>,
      route: "/promotion",
    },
    {
      ...
      title: "Refer & Earn",
      img: <svg xmlns="http://www.w3.org/2000/svg" width="28" height="29" viewBox="0 0 28 29" fill="none">
      <path d="M9.83658 0.45549C6.17555 0.45549 3.19922 3.43765 3.19922 7.10584C3.19922 10.704 6.00787 13.6162 9.6689 13.7422C9.78069 13.7282 9.89248 13.7282 9.97632 13.7422H10.0462H10.0741C13.6513 13.6162 16.46 10.704 16.4739 7.10584C16.4739 3.43765 13.4976 0.45549 9.83658 0.45549Z" fill="white"/>
      <path d="M16.9357 17.4649C13.0371 14.8608 6.67928 14.8608 2.75276 17.4649C0.978138 18.655 0 20.2651 0 21.9872C0 23.7092 0.978138 25.3053 2.73879 26.4814C4.69506 27.7975 7.26617 28.4555 9.83727 28.4555C12.4083 28.4555 14.9794 27.7975 16.9357 26.4814C18.6963 25.2913 19.6745 23.6952 19.6745 21.9592C19.6605 20.2371 18.6963 18.641 16.9357 17.4649Z" fill="white"/>
      <path d="M25.1905 7.92949C25.4141 10.6456 23.4857 13.0257 20.8168 13.3477C20.8028 13.3477 20.8028 13.3477 20.7889 13.3477H20.7469C20.6631 13.3477 20.5793 13.3477 20.5094 13.3757C19.154 13.4457 17.9103 13.0117 16.9741 12.2136C18.4134 10.9256 19.2378 8.99354 19.0701 6.89343C18.9723 5.75937 18.5811 4.72331 17.9942 3.84127C18.5252 3.57525 19.14 3.40724 19.7688 3.35124C22.5076 3.11323 24.9529 5.15734 25.1905 7.92949Z" fill="white"/>
      <path d="M27.9849 20.883C27.8731 22.2411 27.0067 23.4171 25.5535 24.2152C24.1562 24.9852 22.3955 25.3493 20.6488 25.3072C21.6549 24.3972 22.2418 23.2631 22.3536 22.0591C22.4933 20.323 21.6689 18.6569 20.02 17.3268C19.0838 16.5848 17.9939 15.9968 16.8062 15.5627C19.8943 14.6667 23.7789 15.2687 26.1683 17.2008C27.4539 18.2369 28.1106 19.5389 27.9849 20.883Z" fill="white"/>
    </svg>,
      route: "refer&earn",
    },
    // {
