...
import cricket from "../../../assetuser/other/Cricket_ball.svg.png";

import getTeamShortName from "../../../../utils/getTeamShortName";
import { useAppSelector } from "@/app/redux-arch/store";
interface CricketDataProps {
  cricketData: Match[] | undefined;
}
...
const CricketData = ({
  ...
  const [matchData, setMatchData] = useState<CricketData[]>([]);
  ...
  useEffect(() => {
    const finaldata =
      ...
      matchData.map((item: any) => {
        let matchItem: any = data.find((ele: any) => ele.match_id == item.gid);
    ...
    const countMatches = matchData.reduce((count, item: any) => {
      const matchItem = data.find(
        (ele: any) => ele.match_id === item.gid && item.iplay === true
      );
      if (matchItem !== undefined) {
        count++;
      }
          ...
          <>
            <div className="flex px-2 md:px-0 justify-between">
              <div className="flex items-center gap-2">
                <Image src={cricket} className="w-[30px] h-[30px]" alt="" />
            ...
            <div
              className={` m-auto w-[100%]  grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3 sm:w-[100wh] mt-[16px] `}
            >
              {matchData.length > 0 &&
                matchData.slice(0, limit ? 9 : 100).map((item: CricketData) => {
                  ...
                  return (
                    <>
                      ...
                      {matchItem && (
                        <Link key={item.gid} href={`/sports/${item.gid}/4`}>
                          <div
                            ...
                            >
                              <div className="flex flex-col w-[100%] h-[100%] min-h-[210px] justify-between pb-3  gap-8">
                                <div className="flex justify-between w-[100%]  ">
                                  <div className="flex items-center w-[100%] px-2 bg-[#FABC37] rounded-tl-[10px] rounded-tr-[10px] justify-between  gap-2">
                                    <div className="marquee-container  w-[100%] text-left text-black">
                                      <p
                                        className={`marquee-text  text-xs w-[200px]  font-bold ${
                                          isRunning &&
                                          isRunningTeamName ==
                                            "ICC world cup 2023" &&
                                ...
                                <div className="flex justify-between gap-1  px-2 w-[100%]">
                                  <div className="flex flex-col justify-between h-[100%]  gap-4 items-center">
                                    ...
                                    <div className="marquee-container">
                                      <p
                                        className={`marquee-text text-center font-bold text-xs w-[80px] ${
                                          isRunning &&
                                          isRunningTeamName ==
                                            item?.ename
                                              .split("/")[0]
                                    ...
                                    <div className="flex w-[100%]">
                                      <button className=" w-[60px] sm:w-[50px] p-1 bg-[#0096FF] text-black font-bold rounded-tl-[6px] rounded-bl-[6px]">
                                        {item?.b1}
                                      </button>
                                      <button className=" w-[60px] sm:w-[50px] p-1 bg-[#FF6A8A] text-black font-bold rounded-tr-[6px] rounded-br-[6px]">
                                        {item?.l1}
                                      </button>
                                    </div>
                                  </div>
                              ...
                              <p className="text-[12px]  text-[#FFF]">
                                ...
                                {item?.ename.split(" / ")[1].split("  ")[1]}
                                    ...
                                    <div className="flex ">
                                      <button className="w-[70px] sm:w-[50px] p-1 bg-[#0096FF] text-black font-bold rounded-tl-[6px] rounded-bl-[6px]">
                                        {item?.b2}
                                      </button>
                                      <button className="w-[70px] sm:w-[50px] p-1 bg-[#FF6A8A] text-black font-bold rounded-tr-[6px] rounded-br-[6px]">
                                        {item?.l2}
                                      </button>
                                    </div>
                                  </div>
                                  ...
                                  <div className="flex flex-col justify-between  gap-4 items-center">
                                    ...
                                    <div className="flex  gap-2">
                                      <button className="w-[80px] flex justify-center items-center py-[6px] p-1 bg-[#35383F] text-black font-bold rounded-[4px]">
                                        <svg
                                          xmlns="http://www.w3.org/2000/svg"
                                          width="19"
                                          height="20"
