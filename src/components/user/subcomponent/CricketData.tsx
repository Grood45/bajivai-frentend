      ...
      <div className="w-[100%]">
        ...
        {matchFilter == "Cricket" ? (
          <>
            ...
            {loading&&<div className="main-fader" responsive-height-comments>
            ...
            >
              {matchData.length > 0 &&
                matchData.slice(0, limit ? 10 : 100).map((item: CricketData) => {
                                ...
                                <div className="flex justify-between gap-1  px-2 w-[100%]">
                                  <div className="flex flex-col justify-between w-[100%] h-[100%]  gap-4 items-center">
                                    ...
                                    <div className="flex w-[100%]">
                                      ...
                                      <button className="w-[100%] p-1 bg-[#FF6A8A] text-black font-bold rounded-tr-[6px] rounded-br-[6px]">
                                        {item?.l1}
                                      </button>
                                    </div>
                                  </div>
