...
import getTeamShortName, { getDisplayDateSoccer } from "../../../../utils/getTeamShortName";
                        ...
                        <Link key={item.id} href={`/sports/${item.gmid}/2`}>
                          ...
                          >
                            ...
                            >
                              ...
                              <p
                               className={`marquee-text  text-xs font-bold w-[80px] ${
                                  isRunning &&
                  ...
                  return (
                    <>
                      ...
                      {matchItem && (
                          <Link key={item.id} href={`/sports/${item.gmid}/2`}>
                          <div
                            className={`bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ... p-[1px] ${
