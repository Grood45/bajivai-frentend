    ...
    return (
      <>
        ...
        >
          ...
          <RiMenu3Fill onClick={onClose} fontSize="25px" color="white" className="absolute top-5 right-4" />
            ...
            <DrawerBody >
             <div className='flex flex-col mt-4 gap-1   '>
                {sidebardata?.map((item)=>{
                    return <div onClick={()=>handleNavigate(item.route)} key={item.id} className='flex hover:bg-gray-600 p-2 pl-4 rounded-lg hover:text-white text-[#fff] font-bold text-sm items-center gap-6'>
             ...
             <div className='flex  gap-1 mt-1  '>
                {media?.map((item)=>{
                    return <Link href="" key={item.id} className='flex hover:bg-gray-600 p-2 pl-4 rounded-lg hover:text-white text-[#fff] font-bold text-sm items-center gap-6'>
